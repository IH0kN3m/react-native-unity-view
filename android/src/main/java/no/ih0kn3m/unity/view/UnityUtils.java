...
public class UnityUtils {
    ...
    public static void unload(final Activity activity, final CreateCallback callback) {
        if (unityPlayer == null) {
            callback.onReady();
            return;
        }
    ...
    public static void reload(final Activity activity, final CreateCallback callback) {
